...
// ── Shared header ──────────────────────────────────────────
const Header=()=>(
<div style={{background:C.bg,borderBottom:`1.5px solid ${C.border}`,padding:“10px 16px”,display:“flex”,alignItems:“center”,justifyContent:“space-between”,flexShrink:0,boxShadow:“0 2px 8px #0001”}}>
<div style={{display:“flex”,alignItems:“center”,gap:10}}>
...
<div style={{fontSize:14,fontWeight:700,whiteSpace:“nowrap”,overflow:“hidden”,textOverflow:“ellipsis”,maxWidth:“70%”}}>{v.contactName}</div>
...
{/* Bottom tab bar */}
<div style={{display:“flex”,background:C.bg,borderTop:`1.5px solid ${C.border}`,flexShrink:0,paddingBottom:“env(safe-area-inset-bottom)”}}>
{tabs.map(t=>(
<button key={t.id} onClick={()=>setMobileTab(t.id)} style={{flex:1,background:“transparent”,border:“none”,cursor:“pointer”,padding:“10px 4px 8px”,display:“flex”,flexDirection:“column”,alignItems:“center”,gap:3,transition:“all .15s”}}>
...
{mobileTab===t.id&&<span style={{width:20,height:2.5,background:C.navy,borderRadius:2}}/>}
</button>
))}
</div>
...
{/* LEFT */}
<div style={{width:240,background:C.bg,borderLeft:`1.5px solid ${C.border}`,display:“flex”,flexDirection:“column”,overflow:“hidden”,flexShrink:0}}>
<VisitsList/>
</div>
{/* CENTER */}
